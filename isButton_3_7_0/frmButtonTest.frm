...
Begin VB.Form frmButtonTest 
   ...
   Begin isButtonTest.isButton cmdArray 
      ...
      _ExtentX        =   2778
      _ExtentY        =   1085
      Icon            =   "frmButtonTest.frx":0028
      Style           =   9
      Caption         =   "With Multiline Text!!!!"
      CaptionAlign    =   2
      BackColor       =   12632256
      ...
      UseMaskColor    =   -1  'True
   End
   Begin isButtonTest.isButton cmdMore 
      Default         =   -1  'True
      Height          =   375
      Left            =   5400
      TabIndex        =   67
   ...
   Begin VB.PictureBox pProps 
      ...
      Begin isButtonTest.isButton cmdVote 
         ...
         EndProperty
      End
      Begin isButtonTest.isButton cmdHomePage 
         Height          =   375
         Left            =   1440
         TabIndex        =   63
         Top             =   1080
         ...
         _ExtentX        =   4471
         _ExtentY        =   661
         Icon            =   "frmButtonTest.frx":AA38
         Style           =   8
         Caption         =   "Go To Fred.cpp Page"
         IconAlign       =   2
         iNonThemeStyle  =   0
         USeCustomColors =   -1  'True
         BackColor       =   15790320
      ...
      Begin VB.Label Label10 
         ...
         Caption         =   $"frmButtonTest.frx":AFD2
         Height          =   855
         Left            =   120
         TabIndex        =   57
         Top             =   120
   ...
   Begin isButtonTest.isButton cmdTab 
      ...
      EndProperty
   End
   Begin isButtonTest.isButton cmdClose 
      Cancel          =   -1  'True
      Height          =   375
      Left            =   7320
      TabIndex        =   64
      ...
      EndProperty
   End
   Begin isButtonTest.isButton cmdGotoPSCPage 
      Height          =   375
      Left            =   2160
      TabIndex        =   65
      Top             =   4800
      ...
      _ExtentX        =   5530
      _ExtentY        =   661
      Icon            =   "frmButtonTest.frx":B2E4
      Style           =   8
      Caption         =   "Go to Planet Source Code.com"
      CaptionAlign    =   2
      iNonThemeStyle  =   0
      BackColor       =   15790320
      HighlightColor  =   8812135
...
Const strLinkAndUpdates As String = "http://www.planetsourcecode.com/vb/scripts/ShowCode.asp?txtCodeId=61476&lngWId=1"
Const strFredHomePage As String = "http://mx.geocities.com/fred_cpp"
...
Private Sub chkEnabled_Click()
    ...
    Dim ni As Integer
    For ni = 0 To 10
        cmdStyle(ni).Enabled = chkEnabled.Value
    Next ni
End Sub
...
Private Sub cmdHomePage_Click()
    cmdHomePage.OpenLink strFredHomePage
End Sub

Private Sub cmdMore_Click()
    frmDefaultAndCancel.Show , Me
End Sub
...
Private Sub Form_Load()
    ...
    cmdArray(0).Caption = "With Multiline Caption!!"
    cmdArray_Click 0
...
Private Sub txtToolTipText_Change()
    cmdArray(0).ToolTipText = ""
    cmdArray(0).ToolTipText = txtToolTipText.Text
End Sub
